...
const topicInStack2 = new sns.Topic(stack2, 'TopicInStack2');
...
(topicInStack2.node.defaultChild as sns.CfnTopic).displayName = Fn.select(1, Fn.split('-', topicInNestedUnderStack1.topicName));
